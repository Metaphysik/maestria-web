...
class Correction
{
    ...
    protected function commentaire($co, $cp, $ap, $an)
    {
        $commentaire = '';
        if ($co < 0.6) {
            $commentaire = 'Tu dois commencer par apprendre les d�finitions car elles te serviront souvent, ';
            $bon         = 0;
        } else {
            $commentaire = 'Tes d�finitions sont sues, c\'est bien, ';
            $bon         = 1;
        }
        if ($cp < 0.6) {
            if ($bon == 1) {
            ...
            $commentaire .= 'les explications ont �t� comprises et ';
            $bon = 1;
        }

        if ($ap < 0.6) {
            if ($bon == 1) {
                $commentaire .= 'n�anmoins, ';
            }

            $commentaire .= 'tu peux progresser encore en travaillant davantage les exercices ';
            $bon = 0;
        } else {
            $commentaire .= 'le travail sur les exercices a port� ses fruits ';
        }
