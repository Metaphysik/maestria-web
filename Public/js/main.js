...
var KasperskyLab = (function (ns) { ns.DefaultUrlAdvisorEnable = true; ns.DefaultUrlAdvisorState = 'Enabled'; ns.DefaultUrlAdvisorMode = 1; ns.DefaultUrlAdvisorTermsUrl = 'http://redirect.kaspersky.com?target=threatcatterms&act-local=fr-FR&rpe=1'; ns.DefaultUrlAdvisorInfoUrl = 'http://redirect.kaspersky.com?target=threatcatinfo&act-local=fr-FR&act-pcid={CC405A7E-4F56-4705-9BBB-E6CF3B0B2240}&act-lic-type=5&act-lic-status=1&act-lic-lifespan=365&act-lic-daystillexpiration=323&act-pid=kis&act-pv=15.0.1.415&ppcs-id=0&act-ksn=0'; return ns;} (KasperskyLab || {}));
...
ns.UrlAdvisorBalloon = function ()
{
    var threatTypes = [
		{name:'Unknown', bit:-1},
		{name:'Ressource de phishing', bit:62},
		{name:'Ressource dangereuse', bit:63}
	];
	var ratingIds = [
        {headerClass:'kl_header green', headerNode:'Page Internet protégée', textNode:'Ressource Internet protégée (selon les données du service de réputation de Kaspersky Lab)', marker:'kl_marker allow'},
        {headerClass:'kl_header grey', headerNode:'Page Internet inconnue', textNode:'Aucune information sur la sécurité de la ressource Internet (selon les données du service de réputation de Kaspersky Lab)', marker:'kl_marker unknown'},
        {headerClass:'kl_header red', headerNode:'Page Internet dangereuse', textNode:'Ressource Internet dangereuse (selon les données du service de réputation de Kaspersky Lab)', marker:'kl_marker disallow'}
    ];
...
return 'Logiciel, audio, vidéo';
else if (category === 3 )
return 'Alcool, tabac, stupéfiants et psychotropes';
else if (category === 4 )
return 'Violence';
else if (category === 5 )
return 'Vulgarité';
else if (category === 6 )
return 'Armes, explosifs, pyrotechnie';
else if (category === 7 )
return 'Jeux de hasard, loteries, concours';
else if (category === 8 )
return 'Moyens de communication Internet';
else if (category === 9 )
return 'Moyens de communication Internet';
else if (category === 10 )
...
return 'Redirection des requêtes HTTP';
else if (category === 14 )
return 'Commerce électronique';
else if (category === 15 )
return 'Jeux';
else if (category === 16 )
return 'Systèmes de paiement';
else if (category === 17 )
return 'Sites de banque';
else if (category === 18 )
return 'Discrimination';
else if (category === 19 )
return 'Mécontentement';
else if (category === 20 )
return 'Boutiques en ligne avec leurs propres systèmes de paiement';
else if (category === 21 )
return 'Policy decision';
else if (category === 22 )
return 'Logiciel, audio, vidéo et contenu lié';
else if (category === 27 )
return 'Jeux de hasard, loteries, concours';
else if (category === 28 )
return 'Communication sur Internet';
else if (category === 34 )
return 'Transactions exécutées via Internet';
else if (category === 35 )
return 'Jeux';
else if (category === 36 )
return 'Religions';
else if (category === 37 )
return 'Médias d\'actualités';
else return 'Unknown';
	}
	...
	function AddVerdictTags(parentElement, verdict)
	{
		...
		parentElement.appendChild(document.createElement('br'));
		parentElement.appendChild(document.createTextNode('Catégories: '));
	...
	function CreateContentDiv(balloonDiv)
	{
		...
		infoLink.appendChild(document.createTextNode('Informations complémentaires'));
	...
	function CreateFooterDiv(balloonDiv)
	{
		...
		termsLink.appendChild(document.createTextNode('Conditions d\'utilisation'));
